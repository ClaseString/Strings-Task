...
export default function Home() {
  ...
  return (
    <div className="container mx-auto p-10">
      ...
      >
        <div className="collapse-title font-semibold justify-center text-center">
          Clase String
        </div>

        <div className="collapse-content text-sm">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. At ut
          commodi aspernatur error reprehenderit distinctio aliquam labore, vero
          voluptates voluptatem et in corporis consequatur doloribus illum, sit
          ratione. Omnis, quod?
        </div>
      </div>
    </div>
